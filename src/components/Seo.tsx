...
const META: Record<string, SeoMeta> = {
  ...
  '/hsk2-simulation': { title_ar: 'محاكاة تدريبية لاختبار HSK2', title_en: 'HSK2 Practice Simulation', desc_ar: 'محاكاة تدريبية بنمط HSK2 — استماع وقراءة بمؤقّت ونتيجة فورية. ليست اختباراً رسمياً.', desc_en: 'An HSK2-style practice simulation — timed listening and reading. Not an official exam.' },
  '/hsk-tests': { title_ar: 'اختبارات HSK التجريبية — HSK1 وHSK2 وHSK3', title_en: 'HSK Practice Tests — HSK1, HSK2, HSK3', desc_ar: 'كل اختبارات HSK التجريبية في مكان واحد: HSK1 وHSK2 وHSK3 بالعربية، بمؤقّت ونتيجة فورية.', desc_en: 'All HSK practice simulations in one place: HSK1, HSK2, HSK3 with timer and instant scoring.' },
  '/games/flashcard': { title_ar: 'لعبة البطاقات الصينية | Flashcard Blitz | NiHao', title_en: 'Chinese Flashcard Game | NiHao', desc_ar: 'لعبة بطاقات سريعة لحفظ كلمات HSK1 بالصينية مع النطق والعربية. اكسب نقاط XP وعملات وتحدَّ نفسك.', desc_en: 'Fast HSK1 Chinese flashcard game with pronunciation and Arabic. Earn XP, coins, and combos.' },
  '/teacher-dashboard': { title_ar: 'لوحة المعلّم | متابعة الطلاب | NiHao', title_en: 'Teacher Dashboard | NiHao', desc_ar: 'لوحة المعلّم في NiHao: اربط طلابك وتابع تقدّمهم في الدروس واختبارات HSK.', desc_en: 'NiHao teacher dashboard: link your students and track their lesson and HSK progress.' },
  '/ai-teacher': { title_ar: 'المعلم الذكي لتعلم الصينية | خطة يومية واختبار سريع | NiHao', title_en: 'AI Chinese Teacher for Arabic Speakers | NiHao', desc_ar: 'استخدم المعلم الذكي في NiHao للحصول على خطة يومية لتعلم الصينية، كلمات HSK، تدريب بينين، اختبار سريع وروابط مناسبة لمستواك.', desc_en: 'Use the NiHao AI Teacher for a daily Chinese study plan, HSK words, pinyin practice, a quick quiz, and links matched to your level.' },
  '/flashcards/hsk3': { title_ar: 'بطاقات HSK3 — تكرار متباعد', title_en: 'HSK3 Flashcards — Spaced Repetition', desc_ar: 'احفظ كلمات HSK3 ببطاقات التكرار المتباعد: الحرف والبينين والمعنى والمثال. مجاني.', desc_en: 'Memorize HSK3 vocabulary with spaced-repetition flashcards: character, pinyin, meaning, example.' },
  '/worksheets/hsk3': { title_ar: 'ورقة عمل HSK3 للطباعة', title_en: 'HSK3 Printable Worksheet', desc_ar: 'ولّد ورقة عمل HSK3 قابلة للطباعة: مفردات وتدريب كتابة وتوصيل واختبار قصير.', desc_en: 'Generate a printable HSK3 worksheet: vocabulary, writing practice, matching, and a short quiz.' },
  '/writing-practice': { title_ar: 'تدريب كتابة الأحرف الصينية', title_en: 'Chinese Character Writing Practice', desc_ar: 'تدرّب على ترتيب كتابة أحرف HSK1–HSK3 الشائعة مع شبكة طباعة. محتوى أصلي.', desc_en: 'Practice stroke order for common HSK1–HSK3 characters with a printable grid.' },
