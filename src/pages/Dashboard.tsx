...
import { calculateXP, averageQuizScore } from '@/lib/learning';
...
export default function Dashboard() {
  ...
  const stats = [
    ...
    { label: t('dashboard.xp'), value: `${xp} XP`, icon: Zap, color: '#f59e0b' },
    { label: 'Avg Score', value: `${avgScore}%`, icon: TrendingUp, color: '#10b981' },
    // Streak placeholder until daily-activity tracking is stored server-side
    { label: 'Current Streak', value: '—', icon: Flame, color: '#FF3333' },
  ];
